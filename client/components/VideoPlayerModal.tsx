...
export function VideoPlayerModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className={`max-w-7xl ${isFullscreen ? "h-screen" : "max-h-[90vh]"} p-0 overflow-hidden`}
      >
        ...
        <div className="p-4 border-t border-border">
          ...
          <div className="p-3 bg-muted/30 rounded-lg neu-card-inset">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              If the video doesn't load or has issues, try switching to a
              different server above.
            </p>
          </div>
        </div>
      </DialogContent>
